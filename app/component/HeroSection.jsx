    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        <div className="max-w-3xl">
          ...
          {/* Subtitle */}
          <p className="uppercase tracking-widest text-xs text-[#b79662] mb-5">
          ...
          <h1 className="text-4xl md:text-5xl xl:text-6xl font-extrabold leading-tight text-white">
            Driving Strategic
            <br />
            <span className="text-[#b79662]">Growth & Execution</span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-5">
            <Link
              href="/contact"
              className="relative overflow-hidden rounded-md border-2 border-[#b79662] px-6 py-3 font-semibold text-white group"
            >
              <span className="absolute inset-0 w-0 bg-[#b79662] transition-all duration-300 group-hover:w-full"></span>
            ...
            <Link
              href="/journey"
              className="px-6 py-3 rounded-md border border-[#4c4949] text-[#e0e0e0] hover:border-[#b79662] hover:text-[#b79662] transition"
            >
              View The Journey
            </Link>
          </div>
