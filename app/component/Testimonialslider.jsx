      ...
      >
        ...
        <div className="bg-[#b3b3b3] p-8 md:p-10 rounded-[2.5rem] border-2 border-transparent h-full flex flex-col relative group hover:border-[#cc0000]/30 transition-all duration-500 shadow-xl">
          ...
          <div className="flex items-center gap-5 mb-6 relative z-10">
            ...
            <div className="w-20 h-20 md:w-24 md:h-24 flex-shrink-0 rounded-2xl overflow-hidden border-2 border-[#cc0000]/20 group-hover:border-[#cc0000] transition-all duration-500">
              <img
                src={item.image}
                alt={item.name}
