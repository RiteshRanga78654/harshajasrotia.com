...
export default function ContactPage() {
  ...
  const handleInitiate = (e) => {
    ...
    Swal.fire({
      ...
      customClass: {
        popup: "rounded-[2rem] md:rounded-[2.5rem] border-4 border-[#cc0000]/10",
    ...
    <main className="bg-white min-h-screen selection:bg-[#cc0000] selection:text-white">
      ...
      <section className="relative h-[60vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-white tracking-tight leading-tight mt-10 md:mt-20 mb-6 md:mb-10">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-5 space-y-8 md:space-y-12 order-2 lg:order-1">
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="flex items-start gap-4 md:gap-6 group">
                  ...
                  <div className="overflow-hidden">
                    <p className="text-[10px] md:text-[12px] font-black text-gray-400 tracking-widest mb-1 ">Professional Email</p>
                    <a href="mailto:contact@harshajasrotia.com" className="text-sm sm:text-base md:text-lg font-bold text-[#111827] hover:text-[#cc0000] transition-colors tracking-tight break-all">
                ...
                <div className="flex items-start gap-4 md:gap-6 group">
                  ...
                  <div>
                    <p className="text-[10px] md:text-[12px] font-black text-gray-400 tracking-widest mb-1 ">Operational Base</p>
                    <p className="text-sm sm:text-base md:text-lg font-bold text-[#111827] tracking-tight">Gurugram, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 md:gap-6 group">
                  ...
                  <div>
                    <p className="text-[10px] md:text-[12px] font-black text-gray-400 tracking-widest mb-1 ">Availability</p>
                    <p className="text-sm sm:text-base md:text-lg font-bold text-[#111827] tracking-tight">IST (GMT +5:30) | 9:00 - 18:00</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#cc0000] p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] text-white overflow-hidden relative group shadow-xl">
              ...
              <h4 className="text-[#222222] font-black text-[11px] md:text-[13px] tracking-[0.4em] mb-6 ">Quick Check</h4>
              <ul className="space-y-4 relative z-10">
                <li className="flex items-center gap-3 text-xs md:text-sm font-bold tracking-widest">
                  <span className="w-2 h-2 bg-white rounded-full flex-shrink-0" /> IIT Patna Foundation
                </li>
                <li className="flex items-center gap-3 text-xs md:text-sm font-bold tracking-widest">
                  <span className="w-2 h-2 bg-white rounded-full flex-shrink-0" /> 20+ Years Excellence
                </li>
              </ul>
              ...
              <form ref={formRef} className="space-y-6 md:space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  <div className="space-y-2">
                    <label className="text-[11px] md:text-[13px] font-black text-gray-400 tracking-widest ml-4 ">Full Name</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] md:text-[13px] font-black text-gray-400 tracking-widest ml-4 ">Organization</label>
                ...
                <div className="space-y-2">
                  <label className="text-[11px] md:text-[13px] font-black text-gray-400 tracking-widest ml-4 ">Inquiry Category</label>
                ...
                <div className="space-y-2">
                  <label className="text-[11px] md:text-[13px] font-black text-gray-400 tracking-widest ml-4 ">Message</label>
                  <textarea rows={5} required placeholder="Describe your project or inquiry..." className="w-full bg-[#f3f4f6] border-none rounded-2xl md:rounded-3xl px-6 py-6 text-[#222222] focus:ring-2 focus:ring-[#cc0000] transition-all outline-none font-medium resize-none" />
                </div>
      ...
      <section className="pb-16 md:pb-24 bg-[#f9fafb] pt-8 md:pt-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8 md:mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-black text-[#222222] tracking-tighter mb-4">Current <span className="text-[#cc0000]">Base</span></h2>
            <p className="text-[#222222] font-bold text-[10px] md:text-xs tracking-widest ">Global Strategy | Local Impact</p>
          ...
          <div className="h-[350px] sm:h-[450px] md:h-[550px] w-full rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl border-4 md:border-8 border-white group relative">
            ...
            <div className="absolute bottom-4 left-4 right-4 md:bottom-10 md:left-10 md:right-auto p-6 md:p-8 bg-white/90 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] shadow-2xl border border-white/20">
               <h4 className="text-[#111827] font-black text-xs md:text-sm mb-1 tracking-widest ">Office HQ</h4>
               <p className="text-gray-500 text-[10px] md:text-xs font-bold tracking-widest mb-4 ">Gurugram, Haryana</p>
               <a href="https://maps.google.com" target="_blank" className="text-[#cc0000] font-black text-[9px] md:text-[10px] flex items-center gap-2 tracking-widest hover:gap-4 transition-all ">
