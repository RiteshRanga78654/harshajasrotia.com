      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="mt-4 rounded-2xl bg-[#1e1e1e]/80 backdrop-blur-xl border border-[#4c4949] shadow-lg">
          <div className="flex items-center justify-between h-16 px-6">
            ...
            <Link
              href="/"
              className="text-lg md:text-xl font-semibold tracking-wide text-[#b79662]"
            >
              Harsha Jasrotia
            </Link>
            ...
            <button
              ...
              className="md:hidden text-[#b79662]"
            >
              <div className="space-y-1.5">
                <span className="block w-6 h-[2px] bg-[#b79662]" />
                <span className="block w-6 h-[2px] bg-[#b79662]" />
                <span className="block w-6 h-[2px] bg-[#b79662]" />
              </div>
            </button>
...
function NavItem({ href, label }) {
  return (
    <Link
      href={href}
      className="relative text-sm font-medium text-[#cfcfcf] hover:text-[#b79662] transition-colors
      after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-[#b79662]
...
function MobileItem({ href, label, setOpen }) {
  return (
    <Link
      ...
      className="text-base font-medium text-[#cfcfcf] hover:text-[#b79662] transition-colors"
    >
      {label}
    </Link>
  );
