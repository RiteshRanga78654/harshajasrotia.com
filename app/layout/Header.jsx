  ...
  return (
    <header className="fixed top-0 backdrop-blur-2xl left-0 w-full z-50">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8">
        <div className="mt-3 mb-3 rounded-2xl bg-[#b3b3b3]/80 backdrop-blur-xl border border-[#ffffff] shadow-lg">
          <div className="flex items-center justify-between h-16 px-6">
            ...
            >
              <div className="space-y-1.5">
                <span className="block w-6 h-[2px] bg-[#ffffff]" />
                <span className="block w-6 h-[2px] bg-[#ffffff]" />
                <span className="block w-6 h-[2px] bg-[#ffffff]" />
              </div>
            </button>
        ...
        {open && (
          <div className="md:hidden mt-3 rounded-2xl bg-[#1e1e1e] border border-[#4c4949] shadow-xl">
            <nav className="flex flex-col px-6 py-6 space-y-5">
              ...
              <MobileItem label="The Journey" href="/the-journey" setOpen={setOpen} />
...
function NavItem({ href, label }) {
  return (
    <Link
      href={href}
      className="relative text-sm font-medium text-[#ffffff] hover:text-[#cc0000] transition-colors
