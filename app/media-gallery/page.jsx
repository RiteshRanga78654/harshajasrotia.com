...
const galleryItems = [
  ...
  { id: 5, type: 'image', size: 'small', title: 'Leadership Summit', category: 'Impact', src: '/Harshjasrotia.com/Ritesh/Photos/P_K00191.JPG' },
       { id: 6, type: 'image', size: 'large', title: 'Pan-India Operations Scale', category: 'Growth', src: '/Harshjasrotia.com/Ritesh/Photos/DSC02174.JPG' },
  { id: 7, type: 'image', size: 'small', title: 'Boardroom Strategy', category: 'Leadership', src: '/Harshjasrotia.com/Ritesh/Photos/DSC02288.JPG' },
  { id: 8, type: 'image', size: 'small', title: 'EdTech Training Workshop', category: 'Education', src: '/Harshjasrotia.com/Ritesh/Photos/DSC02328.JPG' },
  { id: 9, type: 'image', size: 'medium', title: 'Real Estate Sales Module', category: 'Real Estate', src: '/Harshjasrotia.com/Ritesh/Photos/P_K00153.JPG' },
  { id: 10, type: 'image', size: 'small', title: 'Leadership Summit', category: 'Impact', src: '/Harshjasrotia.com/Ritesh/Photos/Screenshot 2026-02-06 170558.png' },
];
    ...
    <main className="bg-white min-h-screen font-sans selection:bg-[#cc0000] selection:text-white">
      ...
      <section className="relative h-[60vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-90">
          <img src="/Harshjasrotia.com/Ritesh/Photos/P_K00316.JPG" className="w-full h-full object-cover" alt="Media Background" />
        </div>
        <div className="absolute inset-0 bg-black/40" />
        <div className="relative z-20 text-center px-6">
          <h1 className="text-5xl md:text-8xl font-black text-white tracking-tight leading-none mt-40 mb-10 ">Strategic <span className="text-[#cc0000]">Footprints.</span></h1>
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            {/* Close Button */}
            <button className="absolute top-10 right-10 text-white text-4xl z-[60] font-light">×</button>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 to-transparent">
                <p className="text-[#cc0000] font-bold tracking-widest text-xs uppercase mb-1">{selectedImage.category}</p>
                <h3 className="text-white text-3xl font-black">{selectedImage.title}</h3>
              </div>
            </motion.div>
          </motion.div>
        )}
