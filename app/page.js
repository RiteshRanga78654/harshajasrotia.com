  ...
  const steps = [
    {
      ...
      detail: "Leading organizational transformation and scaling Pan-India revenue operations."
    },
    {
      year: "2018 - 2023",
      role: "Business Head",
      company: "Tier-1 EdTech Firm",
      detail: "Scalability from 0 to 100+ cities, managing high-performance sales forces."
    },
    {
      year: "2010 - 2017",
      role: "Real Estate Strategist",
      company: "Major Realty Group",
      detail: "Pioneered luxury sales training modules and high-ticket closing frameworks."
    },
    {
      year: "The Foundation",
      role: "IIT Patna",
      company: "The Academic Root",
      detail: "Developing the core analytical mindset that drives every business decision."
    }
  ];
...
<div className="absolute -top-4 -left-3 md:-top-6 md:-left-6 w-24 h-24 md:w-32 md:h-32 border-t-2 border-l-2 border-[#cc0000] z-10" />            
          ...
          >
            ...
            <div className="space-y-6 text-[#f4f4f4] text-lg leading-relaxed">
              ...
              <p>
                From spearheading massive Pan-India expansions in the <strong>EdTech</strong> sector to 
                architecting luxury sales modules in <strong>Real Estate</strong>, his career is defined 
                by the ability to turn fragmented operations into predictable, scalable revenue engines.
              </p>
              <p>
                Beyond the numbers, Harsha is a dedicated mentor, having empowered over <strong>1,000+ professionals</strong> 
                to master the art of the high-ticket close and strategic marketing.
              </p>
            </div>
            ...
            >
              ...
              <div className="absolute -bottom-6 left-6 right-6 bg-white p-4 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-50">
                   <span className="text-4xl font-black text-gray-300">{item.stat}</span>
                   <span className="text-gray-900 font-bold group-hover:translate-x-2 transition-transform">→</span>
                </div>
              </div>
            </motion.div>
          ))}
